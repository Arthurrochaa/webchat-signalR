...
function openChat(e, sender, message) {
    ...
    if (!checkIfElementExist(user.id, 'chat')) {
        ...
        <footer>
            <input type="text" id="chatFieldMessage" placeholder="Digite aqui sua mensagem" data-chat="${ user.id}">
            <a onclick="sendMessage(this)" id="btnSend" data-chat="${ user.id}">Enviar</a>
        </footer>
        </section>
        `
        ...
        var input = document.getElementById("chatFieldMessage");
